...
window.onload = function () {
   ...
   if (valores) {
      ...
      //FUNCION GET
      $.ajax({
         url: `https://gd548c9243e8650-g7ri4s1qk8952qk0.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/boat/boat/${id}`,
         type: "GET",
         dataType: "json",
         success: function (barcos) {
            ...
            for (let i = 0; i < cs.length; i++) {
               ...
               MyTBody += `<th>${cs[i].brand}</th>`;
               MyTBody += "<th>" + cs[i].model + "</th>";
               MyTBody += "<th>" + cs[i].category_id + "</th>";
               MyTBody += "<th>" + cs[i].name + "</th>";
               MyTBody += "</tr>";
               MyTBody += `<tr><td colspan="5">&nbsp;</td></tr>`;
               MyTBody += `<tr><td colspan='5' class='centrarBotonCancelar'><a href='boats.html' class='linkBtn'>Back</a></td></tr>`;
            }
